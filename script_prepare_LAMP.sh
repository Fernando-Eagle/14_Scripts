...
clear
echo -e "${fundoazul}Este Script irá guiá-lo para atualizar seu Sistema Operacional${NORMAL}"
echo -e "${fundoazul}Também irá guiá-lo para fazer backup das paginas do servidor Apache${NORMAL}"
echo -e "${fundoazul}Bem como do SGBD MySQL ou MariaDB instalado${NORMAL}"
...
if [ -e "/home/$USER/Downloads/Backup_Portal" ]
then
...
sleep 3
mkdir /home/$USER/Downloads/Backup_Portal
...
declare DIR_BACKUP="/home/$USER/Downloads/Backup_Portal/"  #  Define o diretório de backup
clear
...
sudo tar cvzf /home/$USER/Downloads/Backup_Portal/bkp_html_$DATA.tar.gz /var/www/html/
clear
echo -e "${amarelo}O backup foi salvo na pasta '/home/$USER/Downloads/Backup_Portal'sob o nome ${fundopurple}'bkp_html_$DATA.tar.gz'${NORMAL}"
sleep 3
...
for banco in $BANCOS
 do
 if [ $CONT -ge 0 ]; then    # ignora o primeiro item do array, cujo conteudo é "databases"
...
###################################################################
clear
echo -e "${fundovermelho}Backup finalizado e salvo em ${fundoazul}'/home/$USER/Downloads/Backup_Portal/$DATA'${NORMAL}"
